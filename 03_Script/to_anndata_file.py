...
# #-------------------------------------
# reference_matrix.write_h5ad(os.path.join(OUTPUTDIR, STEP3, REFERENCE_NAME, OUTPUT_NAME_REF_MATRIX + ".h5ad"))

# anndata_ref_matrix = an.read_h5ad(os.path.join(OUTPUTDIR, STEP3, REFERENCE_NAME, OUTPUT_NAME_REF_MATRIX + ".h5ad"))
...
# # metadata inside
# #-------------------------------------
# reference_metadata = pd.read_csv(os.path.join(OUTPUTDIR, STEP3, REFERENCE_NAME, OUTPUT_NAME_REF_METADATA + ".csv"), index_col = CELLS_COLUMN )
# anndata_ref_matrix.obs = pd.concat([anndata_ref_matrix.obs, reference_metadata], axis=1, join='inner')

# anndata_ref_matrix.write_h5ad(os.path.join(OUTPUTDIR, STEP3, REFERENCE_NAME, OUTPUT_NAME_REF_MATRIX + "_join_metadata.h5ad"))
