...
# Load the model
#-------------------------------------
model = os.path.join(OUTPUTDIR, STEP3, REFERENCE_NAME, EPOCH)
...
cell_prediction.to_csv(os.path.join(OUTPUTDIR, STEP3, SAMPLE_ID, SAMPLE_ID + "_" + MATRIX + "_prediction.csv"), index = False)