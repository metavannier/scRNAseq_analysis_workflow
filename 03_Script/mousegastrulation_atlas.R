...
dir.create(file.path(OUTPUTDIR, STEP3, "mousegastrulation"))
fwrite(x = sims_count_atlas_matrix , file = file.path( OUTPUTDIR, STEP3, paste0( "mousegastrulation/",OUTPUT_NAME_REF_MATRIX,".csv")), row.names = TRUE)
...
coldata <- DataFrame(Cell=colData(sims_count_atlas)$cell,CellType=colData(sims_count_atlas)$celltype)
coldata <- as.data.frame(coldata)

fwrite(x = coldata , file = file.path( OUTPUTDIR, STEP3, paste0( "mousegastrulation/",OUTPUT_NAME_REF_METADATA,".csv")), row.names = TRUE)
rm(coldata)
...
fwrite(x = sims_count_data_matrix , file = file.path( OUTPUTDIR, STEP3, paste0( "mousegastrulation/",OUTPUT_NAME_MATRIX,".csv")), row.names = TRUE)
rm(sims_count_data)
